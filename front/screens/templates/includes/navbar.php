	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container-fluid">
		  <a class="navbar-brand order-first " href="">
		  	<img src="assets/img/logo.png" alt="" >
		  </a>

		  <button class="navbar-toggler collapsed mx-auto" type="button" data-toggle="collapse" data-target="#navbarsExample09" aria-controls="navbarsExample09" aria-expanded="false" aria-label="Toggle navigation">
			<span class="ti-menu"></span>
		  </button>
	  
		  <div class="collapse navbar-collapse text-center mr-3" id="navbarsExample09">
		...
		<a href="donate" class="top-btn ml-auto mr-auto order-first order-md-2">Donate Now</a>
	</div>
</nav>
